...
?>
    	...
    	<div class="formfieldcontrols" style="width: 580px"><input name="msg_recips" type="text" class="textfield" id="msg_recips" style="width: 99%" value="<?php echo $newsletter->get_recipients(); ?>" onchange="gu_set_modified(true)" placeholder="<?php echo t('Add list here with Add button only');?>" /></div>
			<div class="formfielddivider"></div>
