...
?>
		...
		<div id="footer"><a href="<?php echo GUTUMA_URL; ?>" onclick="window.open(this.href);return false;">Gutuma</a> <?php echo t('is released under the GPL');?> | &copy; Rowan &amp; Swd<?php echo isset($_SESSION['user'])?' | <a href="https://web.archive.org/web/20151029055359/http://www.gutuma.com/support.php">'.t('Help').'</a> | <a href="../../../core/admin/'.($_SESSION['profil'] == PROFIL_ADMIN?'plugin.php?p=gutuma':'').'">Admin PluXml</a>':''; ?></div>
<?php
