...
<div style="clear: both">
	...
	<input type="image" src="img/paypal/en/x-click-but04.gif" border="0" name="submit" alt="<?php echo t('PayPal - The safer, easier way to pay online.');?>">
	...
	<p class="text-justify"><?php echo t('Gutuma is free open source software released under the GPL version 3 licence. However, if you would like to assist further development of this project please consider making a donation, which will be much appreciated.');?></p>
</div>