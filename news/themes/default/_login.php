...
<div style="text-align: center">
	<form name="login_form" method="post" action="login.php?action=login<?php echo (is_get_var('ref') ? ('&amp;ref='.urlencode(get_get_var('ref'))) : ''); ?>" onsubmit="return loginSubmit(this);">
		...
		<p><input name="login_remember" type="checkbox" id="login_remember" value="TRUE" /><?php echo t('Remember me');?></p>  
		<p><input name="login_submit" type="submit" id="login_submit" value="<?php echo t('Log In');?>" /></p>
	</form>
</div>