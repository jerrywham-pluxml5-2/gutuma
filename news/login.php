...
function loginSubmit(form){
	form.p.value = hex_md5(form.dummy_p.value);// MD5 encrypt the password and store in hidden field
...
<?php
include_once 'themes/'.gu_config::get('theme_name').'/_login.php';//Body
gu_theme_end();