...
tinymce.PluginManager.add('codemirror', function (e, r) {
  function o() {
    e.focus();
    ...
    if (e.settings.codemirror.width) {
      codemirrorWidth = e.settings.codemirror.width
    }
    codemirrorHeight = 550;
    if (e.settings.codemirror.width) {
      codemirrorHeight = e.settings.codemirror.height
    }
    var o = {
