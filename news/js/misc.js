...
{
	setMsge(id);
	// Start element 100% transparent
	gu_element_set_opacity(id, 0);
	
	// Display element
	gu_element_set_display(id, display);
	
	// Animate fade in
	gu_element_fade(id, duration, 0, 100);
}
...
{
	// Animate fade out
	gu_element_fade(id, duration, 100, 0);
	
	// Hide element completely at end of fade
	setTimeout("gu_element_set_display('" + id + "', 'none');", duration);
}
