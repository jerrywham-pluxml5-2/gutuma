//tylermcginnis.com/validate-email-address-javascript/
function mailIsValid(mail) {
	return /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(mail)
}
/*from pluxml/core/lib/function.js (v5.7)*/
//this gutuma function.js is used in newsletters.php, (edit)list.php
